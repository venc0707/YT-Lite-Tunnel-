...
Since the project is open source, you're not limited to the public server.

Хотите поднять свой сервер? Пишите нам в [Telegram](https://t.me/+s87tEkPayo9iOWFi) — поможем.
